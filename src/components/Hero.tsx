      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-5xl md:text-6xl font-bold mb-6">
            Vistoria Veicular
            <span className="text-red-500 block">Profissional</span>
          </h1>
          <p className="text-xl md:text-2xl mb-8 text-gray-300">
            Serviços especializados em vistoria para carros, motos e caminhões em Louveira
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
            <div className="flex flex-col items-center">
              ...
              <p className="text-gray-300">Vistoria completa e detalhada para sua segurança</p>
            </div>
            <div className="flex flex-col items-center">
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-gray-300">Profissionais qualificados e experientes</p>
            </div>
          </div>
        </div>
      </div>
